...
public partial class GradeCountReport : System.Web.UI.Page
{
    DataTable Table;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Path = Server.MapPath("~/Reports/GradeCountReport.html");
    ...
    private DataTable DataForReport()
    {
        ...
        {
            string query = "Select COUNT(*) as 'Grade Count',grade as 'Grade' From enrollment Where grade is NOT NULL Group By grade;";
