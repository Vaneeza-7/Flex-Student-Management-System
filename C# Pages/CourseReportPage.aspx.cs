...
public partial class CourseReportPage : System.Web.UI.Page
{
    DataTable Table;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Path = Server.MapPath("~/Reports/CoursesOfferedReport.html");
    ...
    private DataTable DataForReport()
    {
        ...
        {
            string query = "SELECT offers.semester as 'Semester',offers.cId as 'Course Code',course.cname 'Course Name',course.crdHrs as 'Credit Hours' FROM offers Inner Join course ON offers.cId = course.code";
