...
public partial class MarksEvaluationReport : System.Web.UI.Page
{
    DataTable Table;
    ...
    private DataTable DataForReport()
    {
        ...
        {
            string query = "select evaluation.cId as 'Course Code', stId as 'Student ID', evaluation.evalType as 'Evaluation Type', obtMarks as 'Obtained Marks', totalMarks as 'Total Marks' from manageMarks inner join evaluation on evaluation.cId=manageMarks.cId and manageMarks.evalType=evaluation.evalType";
