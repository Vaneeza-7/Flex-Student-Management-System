    ...
    <form id="form2" runat="server">
        ...
        <div style="margin-left: 40px; margin-right: 40px; margin-top: 60px; height: 900px; border: thin solid #1E90FF;">
            ...
            <p style="background-color: dodgerblue; height: 40px; margin-top: 0px">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Label ID="Label3" runat="server" BorderColor="DodgerBlue" BorderStyle="Solid" BorderWidth="5px" Font-Bold="True" Font-Names="Times New Roman" Font-Overline="False" Font-Size="X-Large" ForeColor="White" Height="28px" style="margin-left: 60px; margin-top: 0px" Text="Marks" Width="187px"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
