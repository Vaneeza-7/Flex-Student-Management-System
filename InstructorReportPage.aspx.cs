...
public partial class InstructorReportPage : System.Web.UI.Page
{
    DataTable Table;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Path = Server.MapPath("~/Reports/AllocationReport.html");
    ...
    private DataTable DataForReport()
    {
        ...
        {
            string query = "Select course.code as 'Course Code',course.cname as 'Course Name',course.crdHrs as 'Credit Hours',coursehaveSec.secId as 'Section',flexuser.username as 'Instructor' from course Inner Join teaches ON course.code = teaches.cId Inner Join flexuser ON teaches.tId = flexuser.id Inner Join coursehaveSec ON teaches.cId = coursehaveSec.code;";
